...
public class MultiToolHolders {
  ...
  public static final Item itemMultiToolHolder3 = (new ItemMultiToolHolder(HolderType.HOLDER3)).setRegistryName(Constants.REG_NAME_ITEM_MULTI_TOOL_HOLDER_3).setTranslationKey(MOD_ID.toLowerCase() + ":Holder3");
  public static final Item itemMultiToolHolder5 = (new ItemMultiToolHolder(HolderType.HOLDER5)).setRegistryName(Constants.REG_NAME_ITEM_MULTI_TOOL_HOLDER_5).setTranslationKey(MOD_ID.toLowerCase() + ":Holder5");
  public static final Item itemMultiToolHolder7 = (new ItemMultiToolHolder(HolderType.HOLDER7)).setRegistryName(Constants.REG_NAME_ITEM_MULTI_TOOL_HOLDER_7).setTranslationKey(MOD_ID.toLowerCase() + ":Holder7");
  public static final Item itemMultiToolHolder9 = (new ItemMultiToolHolder(HolderType.HOLDER9)).setRegistryName(Constants.REG_NAME_ITEM_MULTI_TOOL_HOLDER_9).setTranslationKey(MOD_ID.toLowerCase() + ":Holder9");
  public static int toolHolderInvX = 0;
  public static int toolHolderInvY = 0;
  public static String[] toolStrArray = new String[]{};
  public static final Set<String> toolNameSet = new HashSet<>();
  public static boolean enableDisplayToolHolderInventory = true;
  public static boolean enableAutChange = true;
  @Mod.Instance(MOD_ID)
  public static MultiToolHolders instance;
  @SidedProxy(clientSide = "ak.mcmod.multitoolholders.client.ClientProxy", serverSide = "ak.mcmod.multitoolholders.CommonProxy")
  ...
  public void preInit(final FMLPreInitializationEvent event) {
    ...
    enableAutChange = config.get(Configuration.CATEGORY_GENERAL, "enableAutoChange", enableAutChange, "enable to change suitable tool automatically").getBoolean();
    config.save();
  ...
  private void addRecipe(final IForgeRegistry<IRecipe> registry) {
    ...
    for (int i = 0; i < toolHolders.length; i++) {
      registry.register(new ShapedOreRecipe(rl, toolHolders[i],
              ...
              'C', new ItemStack(Blocks.TRIPWIRE_HOOK)).setRegistryName(Objects.requireNonNull(toolHolders[i].getItem().getRegistryName())));
    }
  }
}